...
// Tabla de transactions del detalle admin de torneo.
...
import { SectionTitle, fmtDate, fmtMoney } from "../event-detail/primitives";

const TOURNAMENT_TXN_COLS = "1fr 100px 80px 110px 140px 150px";

type Tx = AdminTournamentDetail["transactions"][number];

export function TournamentTransactionsTable({
  transactions,
}: {
  transactions: AdminTournamentDetail["transactions"];
}) {
      ...
      <div className="card mp-table-scroll" style={{ padding: 0, overflow: "hidden" }}>
        ...
        {transactions.map((t, i) => (
          <div
            ...
            style={{
              display: "grid",
              gridTemplateColumns: TOURNAMENT_TXN_COLS,
              gap: 10,
              padding: "12px 16px",
              alignItems: "center",
    ...
    >
      ...
      >
        ...
        <textarea
          ...
          rows={3}
          maxLength={500}
          placeholder="Ej: el torneo se reprogramó y el jugador no puede asistir."
          style={fieldInput}
        />
